                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-1">
                                    ...
                                    <textarea name="description" id="description" class="form-control" placeholder="Enter role description "></textarea>
                                </div>
                                <div class="col-md-6 mb-1">
                                    <label for="lavel">Lavel</label>
                                    <input type="text" maxlength="1" name="lavel" id="lavel" class="form-control"
                                        placeholder="Enter role lavel" value="0">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        @foreach ($permissions as $model => $modelPermissions)
                                            <div class="card w-25 m-1">
                                                <div class="card-header">
                                                    <div class="icheck-primary d-inline model">
